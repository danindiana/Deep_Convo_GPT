...
def visualize_activation_maps(activation_tensor):
    """Save high-resolution activation maps (feature maps) from a given layer to a file."""
    fig, axes = plt.subplots(4, 8, figsize=(16, 16), dpi=200)  # Increased size and resolution
